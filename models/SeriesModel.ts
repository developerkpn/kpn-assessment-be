  ...
  try {
    ...
    const seriesDetail = {
      ...
      questions: result.rows.map(row => ({
        ...
        answer_choices: {
          a: { text: row.answer_choice_a_text, image: row.answer_choice_a_image_url },
          b: { text: row.answer_choice_b_text, image: row.answer_choice_b_image_url },
          c: { text: row.answer_choice_c_text, image: row.answer_choice_c_image_url },
          d: { text: row.answer_choice_d_text, image: row.answer_choice_d_image_url },
          e: { text: row.answer_choice_e_text, image: row.answer_choice_e_image_url },
        },
        key_answers: {
          a: row.key_answer_point_a,
          b: row.key_answer_point_b,
          c: row.key_answer_point_c,
          d: row.key_answer_point_d,
          e: row.key_answer_point_e,
        },
